...
<body>
	...
	<div class="s_info row">
		...
		<div class="p_fix">
			<form class="p_option" name="myform1" action="">
				<div id="p_position">
					...
					<span>수량 : </span> <select id="figure" class="figure" name="figure">
		...
		<div id="detail_delivery">
			...
			<h3>반품 시 먼저 판매자와 연락하셔서 반품사유, 택배사, 배송비, 반품지 주소 등을 협의하신 후 반품상품을
				발송해 주시기 바랍니다.</h3>
			<h3>1. 구매자 단순 변심은 상품 수령 후 7일 이내 (구매자 반품배송비 부담)</h3>
			<h3>2. 표시/광고와 상이, 상품하자의 경우 상품 수령 후 3개월 이내 혹은 표시/광고와 다른 사실을 안
				날로부터 30일 이내. 둘 중 하나 경과 시 반품/교환 불가 (판매자 반품배송비 부담)</h3>
			...
			<h3>5. 시간의 경과에 의하여 재판매가 곤란할 정도로 상품 등의 가치가 현저히 감소한 경우 (예: 식품,
				화장품)</h3>
